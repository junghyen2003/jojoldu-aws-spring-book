...
import com.jojoldu.book.aws_spring_book.config.auth.dto.OAuthAttributes;
...
import com.jojoldu.book.aws_spring_book.domain.user.UserRepository;
...
public class CustomOauth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // OAuth2UserService를 통해 가져온 OAuth2UserService를 통해 가져온 OAuth2User의 attribute를 담을 클래스
